            ...
            <div class="modal-body" style="height:300px">
              ...
              <form class="form-horizontal" method="post" action="combo_update.php" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="name" id="title"
                         placeholder="Combo Name" value="<?php echo $name;?>">
                      </div>
                  </div> 
                  <!-- Title -->
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        ...
                        placeholder="Price of Combo Meal" value="<?php echo $price;?>">
                      </div>
                  </div> 
                  <!-- Title -->
                  <!-- Title -->
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <select class="form-control select2 " id="exampleSelect1" name="menu[]"
                         multiple='multiple' style="width: 100%;height:200px" placeholder="Select multiple members">
                        <?php
