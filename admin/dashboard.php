    ...
    <div class="navbar navbar-fixed-top bs-docs-nav" role="banner">
        ...
        <div class="conjtainer">
            ...
            <div class="navbar-header">
                ...
                <a href="index.html" class="navbar-brand hidden-lg">Daffodil Food Court</a>
            </div>
                                                ...
                                                <li class="active"><a href="#"><i class="icon-dashboard icon-2x">
                                                            <div class="span10">
                                                                <div class="contentheader">
                                                                    <ul class="breadcrumb">
                                                                        <font
                                                                            style=" font:bold 44px 'Aleo'; text-shadow:10px 10px 50px #000; color:black;">
                                                                            <center>Daffodil Food Court</center>
                                                                        </font>
                                                                        <div id="mainmain">
                                                                            ...
                                                                            <div id="jssor_1"
                                                                                ...
                                                                                <div data-u="navigator" class="jssorb05"
                                                                                    ...
                                                                                    <div data-u="prototype"
                                                                                        style="width:1000px;height:16px;">
                                                                                    </div>
                                                                                </div>
                                                                                <!-- Arrow Navigator -->
                                                                        ...
                                                                        <div data-u="navigator" class="jssorb05"
                                                                            ...
                                                                            <!-- bullet navigator item prototype -->
                                                                            <div data-u="prototype"
                                                                                style="width:1000px;height:16px;"></div>
                                                                        </div>
                                                                        <!-- Arrow Navigator -->
