...
<body>
<h3 style="text-align:center">KUSUMNIBASH Restaurant Catering Services</h3>
<h4 style="text-align:center">Taltola,Dhamrai,Dhaka</h4>
<h4 style="text-align:center">Phone No. : 01832788599</h4>
<h4 style="text-align:center">Gmail : kusumnibash@gmail.com</h4>
<h4 style="text-align:center">Facebook : facebook.com/KUSUMNIBASH Restaurant </h4>
<hr>
...
<?php
    ...
    $query1=mysqli_query($con,"select * from r_details natural join combo where rid='$id'")or 
...
<div style="width:50%;float:left">
  ...
  <span>No. of persons: <?php echo $row1['r_nop'];?> * <?php echo $row1['r_price'];?> 
  = P <?php echo $row1['r_nop']*$row1['r_price'];?></span>
  <ul>
<?php
      $query2=mysqli_query($con,"select * from r_combo natural join menu where r_details_id='$rid'")
